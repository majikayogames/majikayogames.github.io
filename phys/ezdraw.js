...
vec2.prototype.normalized = vec2.prototype.normal = function() { return vec2(this.x / this.magnitude(), this.y / this.magnitude()); };
...
vec3.prototype.normalized = vec3.prototype.normal = function() { return new vec3(this.x / this.magnitude(), this.y / this.magnitude(), this.z / this.magnitude()); };
